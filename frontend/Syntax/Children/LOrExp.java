...
public class LOrExp {
    static void LOrExpAnalysis() {
        ...
        while (token.tk.equals("AND") || token.tk.equals("OR")
                || token.tk.equals("EQL") || token.tk.equals("NEQ")
                || token.tk.equals("LSS") || token.tk.equals("LEQ")
                || token.tk.equals("GRE") || token.tk.equals("GEQ")) {
            // && || == != < <= > >=
